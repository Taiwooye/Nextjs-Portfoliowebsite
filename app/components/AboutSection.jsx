...
const AboutSection = () => {
  ...
  return (
    ...
    <Image src={computer} width={500} height={600} alt="computer"/>
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full ">
          <h2 className="text-4xl font-bold text-white mb-4">About Me</h2>
          <p className="text-base lg:text-lg">
            I am a frontend web developer with a passion for creating
            interactive and responsive web applications. I have experience
            working with JavaScript, Reactjs, Nextjs, Tailwind, HTML, CSS, and Git. I am a quick learner and I am always
